...
class CreateApApplicationsTable extends Migration
{
    ...
    public function up ()
    {
        Schema::create ('ap_applications', function (Blueprint $table)
        {
            ...
            $table->unsignedInteger ('template_id')->nullable (false)->comment ('关联流程模版');
            ...
            $table->string ('state')->nullable (false)->default (0)->comment ('提交状态 0 草稿 1 已提交待审核 2 审核完成 3 审核失败');
            $table->binary('serialized_workflow')->comment('流程内容');
