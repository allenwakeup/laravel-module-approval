...
class CreateApCrewsTable extends Migration
{
    ...
    public function up ()
    {
        Schema::create ('ap_crews', function (Blueprint $table)
        {
            ...
            $table->unsignedInteger ('staff_primary')->default (0)->comment ('审批人1');
            $table->unsignedInteger ('staff_secondary')->default (0)->comment ('审批人2');
            $table->unsignedInteger ('staff_other')->default (0)->comment ('审批人3');
