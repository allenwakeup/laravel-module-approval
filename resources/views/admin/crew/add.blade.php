...
@section('content')
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form class="layui-form" action="@if(isset($id)){{ route ('admin::' . module_route_prefix ('.') . 'approval.crew.update', ['id' => $id]) }}@else{{ route ('admin::' . module_route_prefix ('.') . 'approval.crew.save') }}@endif" method="post">
