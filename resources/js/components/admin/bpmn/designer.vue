  ...
  <div class="bpmn">
    <div class="tool">
      ...
      <a-input type="file"
        id="files"
        ref="refFile"
        style="display: none" @change="loadXML" />
    </div>
    <div ref="palette"></div>
...
import { xmlStr } from './example.bpmn' // 这里是直接引用了xml字符串
import {
  append as svgAppend,
  attr as svgAttr,
  create as svgCreate
...
import { _fitViewport } from '@/components/admin/bpmn/customBpmn/utils/index.js'
